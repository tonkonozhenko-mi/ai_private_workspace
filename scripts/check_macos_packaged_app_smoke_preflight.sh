...
check_file "frontend/src-tauri/src/main.rs" "Tauri supervisor bridge"
...
check_contains "frontend/src-tauri/src/main.rs" 'GET /health HTTP/1.1' "Tauri startup waits for HTTP /health"
check_contains "frontend/src-tauri/src/main.rs" 'start_app_owned_backend_runtime' "Tauri app-owned backend startup command exists"
check_contains "frontend/src-tauri/src/main.rs" 'stop_app_owned_backend_runtime' "Tauri PID-owned shutdown command exists"
check_contains "frontend/src-tauri/src/main.rs" 'AI_WORKBENCH_DB_PATH' "Tauri passes app-owned DB path to backend"
check_contains "docs/CONTINUE_MESSAGE.md" 'Task 251' "continuation checkpoint includes Task 251"

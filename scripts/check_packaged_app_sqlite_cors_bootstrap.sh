...
check_contains backend/app/config/settings.py '"AI_WORKSPACE_APP_DATA_DIR"' "settings accepts legacy app data env alias"
check_contains backend/app/config/settings.py '"AI_WORKBENCH_DB_PATH"' "settings accepts legacy DB path env alias"
...
check_contains frontend/src-tauri/src/lib.rs '.env("WORKSPACE_DB_PATH", workspace_db_path())' "Tauri sets canonical WORKSPACE_DB_PATH"

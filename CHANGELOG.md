...
- **Change history timeline.** A new **History** tab under Project Intelligence keeps a durable, timestamped record of every watch check that found changes — its summary, risk/structural counts and the commit subjects — so the "what changed since last time" digest no longer vanishes when you leave the view. Entries are logged automatically; a generated one-tap summary is saved onto its entry too.

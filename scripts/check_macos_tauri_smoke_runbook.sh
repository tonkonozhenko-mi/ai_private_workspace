...
require_absent_text "frontend/src-tauri/src/lib.rs" "pkill"
require_absent_text "frontend/src-tauri/src/lib.rs" "killall"
require_absent_text "frontend/src-tauri/src/lib.rs" "taskkill"
require_absent_text "frontend/src-tauri/src/lib.rs" "sh -c"
require_absent_text "frontend/src-tauri/src/lib.rs" "cmd /C"

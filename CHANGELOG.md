...
- **A gentle first-run orientation so a new user knows where to start.** Opening a fresh project now shows a small "Start here" card on Home with three steps — get the local AI ready, ask your first question, explore your project's map — each a real button that takes you to the right place and checks itself off as you go. It disappears once you're set up and can be dismissed at any time. The first time you open each section, a one-line caption explains what it's for, then quietly goes away. No modal tour, nothing blocking — the app teaches in place and gets out of the way once you've found your footing.

...
DEFAULT_LOCAL_MODELS = [
    ...
    LocalModelDefinition(
        ...
        description="Modern, compact general assistant — strong at code and reasoning, fits 8 GB.",
        capabilities=["workspace_ask", "summarization", "code_analysis", "devops_analysis"],
        ...
        local_only=True,
        notes=[
            "Recommended modern default answer model.",
            "Exact size and context window depend on the installed Ollama variant.",
        ],
    ),
    LocalModelDefinition(

"""Repository / provider / gateway factories for the API container.

Extracted from app.api.dependencies to keep that module focused on wiring
the singletons. These are pure factory functions with no module-level state.
"""
